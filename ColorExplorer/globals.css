...
const ArcoirisMessageInputSchema = z.object({
  ...
  itemName: z.string().optional().describe('The name of the item (color or number) being guessed.'),
});
...
Your goal is to provide short, positive, and varied messages to a 7-year-old child learning colors or numbers.
